...
namespace SimpleH2downloader { namespace AssetBundles {
    ...
    {
        const string kSimulationMode = "Tools/SimpleH2downloader/AssetBundles/Simulation Mode";
        ...
        [MenuItem("Tools/SimpleH2downloader/AssetBundles/Build AssetBundles")]
        static public void BuildAssetBundles()
        {
            BuildScript.BuildAssetBundles();
        }

        [MenuItem ("Tools/SimpleH2downloader/AssetBundles/Build Player (for use with engine code stripping)")]
        static public void BuildPlayer ()
        {
            BuildScript.BuildPlayer();
        }

        [MenuItem("Tools/SimpleH2downloader/AssetBundles/Build AssetBundles from Selection")]
